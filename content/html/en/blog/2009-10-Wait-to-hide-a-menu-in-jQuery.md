...
I discussed [earlier why I prefer to hide my navigation menu](/n3blog/en/blog/2009-10-Focus-vs-Minimalism). I finally decided to hide it only after a short time. Just the time needed for a user to see it. But how make it disappear only when it is not used for some time?
